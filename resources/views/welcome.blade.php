...
<head>
    ...
    <title>{{ __('custom.extraordinary_settlements') }}</title>
                ...
                <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                        <div class="px-4 py-5 flex-auto">
                            ...
                            <h6 class="text-xl font-semibold">{{ Str::title(__('custom.trading_posts')) }}</h6>
            ...
            <div class="flex flex-wrap items-center mt-32">
                ...
                <div class="w-full md:w-4/12 px-4 mr-auto ml-auto">
                    ...
                    >
                        <img
                            alt="..."
                            src="{{ Vite::asset('resources/images/spectacular_settlement.jpg') }}"
            ...
            <div class="flex flex-wrap">
                <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                    <div class="px-6">
                        <img
                            alt="..."
                            src="{{ Vite::asset('resources/images/team-1-800x800.jpg') }}"
                ...
                <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                    <div class="px-6">
                        <img
                            alt="..."
                            src="{{ Vite::asset('resources/images/team-2-800x800.jpg') }}"
                            class="shadow-lg rounded-full max-w-full mx-auto"
                            style="max-width: 120px;"
                        />
                        <div class="pt-6 text-center">
                ...
                <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                    <div class="px-6">
                        <img
                            alt="..."
                            src="{{ Vite::asset('resources/images/team-3-800x800.jpg') }}"
                            class="shadow-lg rounded-full max-w-full mx-auto"
                            style="max-width: 120px;"
                        />
                        <div class="pt-6 text-center">
                ...
                <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                    <div class="px-6">
                        <img
                            alt="..."
                            src="{{ Vite::asset('resources/images/team-4-470x470.png') }}"
                            class="shadow-lg rounded-full max-w-full mx-auto"
                            style="max-width: 120px;"
                        />
                        <div class="pt-6 text-center">
